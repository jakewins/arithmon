# STORY-0123: Boltnu monster line

## Description

Port the boltnu-line evolution line from upstream Tuxemon into Arithmon. This is a content-only story — the monster engine (types, stats, moves, evolution, combat) is in place; this story registers the species in our data layer and copies the sprite assets.

The chain contains 2 monsters:
- **boltnu** (basic, blob, metal) — evolves into exclawvate at see upstream YAML
- **exclawvate** (stage1, dragon, metal) — evolves from boltnu

### Upstream reference

- `upstream/mods/tuxemon/db/monster/boltnu.yaml`
- `upstream/mods/tuxemon/db/monster/exclawvate.yaml`
- Sprites:
- `upstream/mods/tuxemon/gfx/sprites/battle/boltnu-sheet.png`
- `upstream/mods/tuxemon/gfx/sprites/battle/exclawvate-sheet.png`
...
- [ ] `MonsterDef` entry for **boltnu** in `src/game/data/monsters.ts`
- [ ] `MonsterDef` entry for **exclawvate** in `src/game/data/monsters.ts`
- [ ] Battle sprite present at `public/assets/sprites/battle/boltnu-sheet.png`
- [ ] Battle sprite present at `public/assets/sprites/battle/exclawvate-sheet.png`
