# STORY-0121: Axolightl monster line

## Description

Port the axolightl-line evolution line from upstream Tuxemon into Arithmon. This is a content-only story — the monster engine (types, stats, moves, evolution, combat) is in place; this story registers the species in our data layer and copies the sprite assets.

The chain contains 2 monsters:
- **axolightl** (basic, polliwog, water) — evolves into ampystoma at see upstream YAML
- **ampystoma** (stage1, brute, lightning/water) — evolves from axolightl

### Upstream reference

- `upstream/mods/tuxemon/db/monster/axolightl.yaml`
- `upstream/mods/tuxemon/db/monster/ampystoma.yaml`
- Sprites:
- `upstream/mods/tuxemon/gfx/sprites/battle/axolightl-sheet.png`
- `upstream/mods/tuxemon/gfx/sprites/battle/ampystoma-sheet.png`
...
- [ ] `MonsterDef` entry for **axolightl** in `src/game/data/monsters.ts`
- [ ] `MonsterDef` entry for **ampystoma** in `src/game/data/monsters.ts`
- [ ] Battle sprite present at `public/assets/sprites/battle/axolightl-sheet.png`
- [ ] Battle sprite present at `public/assets/sprites/battle/ampystoma-sheet.png`
