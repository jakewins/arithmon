# STORY-0075: Boxali monster line

## Description

Port the boxali-line evolution line from upstream Tuxemon into Arithmon. This is a content-only story — the monster engine (types, stats, moves, evolution, combat) is in place; this story registers the species in our data layer and copies the sprite assets.

The chain contains 1 monster:
- **boxali** (standalone — does not evolve, brute, heroic/sky) — terminal (no evolution)

### Upstream reference

- `upstream/mods/tuxemon/db/monster/boxali.yaml`
- Sprites:
- `upstream/mods/tuxemon/gfx/sprites/battle/boxali-sheet.png`
...
- [ ] `MonsterDef` entry for **boxali** in `src/game/data/monsters.ts`
- [ ] Battle sprite present at `public/assets/sprites/battle/boxali-sheet.png`
