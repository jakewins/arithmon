# STORY-0131: Eyenemy monster line

## Description

Port the eyenemy-line evolution line from upstream Tuxemon into Arithmon. This is a content-only story — the monster engine (types, stats, moves, evolution, combat) is in place; this story registers the species in our data layer and copies the sprite assets.

The chain contains 2 monsters:
- **eyenemy** (basic, serpent, cosmic) — evolves into eyesore at see upstream YAML
- **eyesore** (stage1, serpent, cosmic) — evolves from eyenemy

### Upstream reference

- `upstream/mods/tuxemon/db/monster/eyenemy.yaml`
- `upstream/mods/tuxemon/db/monster/eyesore.yaml`
- Sprites:
- `upstream/mods/tuxemon/gfx/sprites/battle/eyenemy-sheet.png`
- `upstream/mods/tuxemon/gfx/sprites/battle/eyesore-sheet.png`
...
- [ ] `MonsterDef` entry for **eyenemy** in `src/game/data/monsters.ts`
- [ ] `MonsterDef` entry for **eyesore** in `src/game/data/monsters.ts`
- [ ] Battle sprite present at `public/assets/sprites/battle/eyenemy-sheet.png`
- [ ] Battle sprite present at `public/assets/sprites/battle/eyesore-sheet.png`
