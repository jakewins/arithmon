# STORY-0163: Agnite monster line

## Description

Port the agnite-line evolution line from upstream Tuxemon into Arithmon. This is a content-only story — the monster engine (types, stats, moves, evolution, combat) is in place; this story registers the species in our data layer and copies the sprite assets.

The chain contains 3 monsters:
- **agnite** (basic, dragon, fire) — evolves into agnidon at see upstream YAML
- **agnidon** (stage1, dragon, fire) — evolves into agnigon at level 24
- **agnigon** (stage2, dragon, fire/shadow) — evolves from agnidon

### Upstream reference

- `upstream/mods/tuxemon/db/monster/agnite.yaml`
- `upstream/mods/tuxemon/db/monster/agnidon.yaml`
- `upstream/mods/tuxemon/db/monster/agnigon.yaml`
- Sprites:
- `upstream/mods/tuxemon/gfx/sprites/battle/agnite-sheet.png`
- `upstream/mods/tuxemon/gfx/sprites/battle/agnidon-sheet.png`
- `upstream/mods/tuxemon/gfx/sprites/battle/agnigon-sheet.png`
...
- [ ] `MonsterDef` entry for **agnite** in `src/game/data/monsters.ts`
- [ ] `MonsterDef` entry for **agnidon** in `src/game/data/monsters.ts`
- [ ] `MonsterDef` entry for **agnigon** in `src/game/data/monsters.ts`
- [ ] Battle sprite present at `public/assets/sprites/battle/agnite-sheet.png`
- [ ] Battle sprite present at `public/assets/sprites/battle/agnidon-sheet.png`
- [ ] Battle sprite present at `public/assets/sprites/battle/agnigon-sheet.png`
