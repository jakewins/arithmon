# STORY-0149: Potturmeist monster line

## Description

Port the potturmeist-line evolution line from upstream Tuxemon into Arithmon. This is a content-only story — the monster engine (types, stats, moves, evolution, combat) is in place; this story registers the species in our data layer and copies the sprite assets.

The chain contains 2 monsters:
- **potturmeist** (basic, blob, earth/shadow) — evolves into potturney at see upstream YAML
- **potturney** (stage1, blob, earth/shadow) — evolves from potturmeist

### Upstream reference

- `upstream/mods/tuxemon/db/monster/potturmeist.yaml`
- `upstream/mods/tuxemon/db/monster/potturney.yaml`
- Sprites:
- `upstream/mods/tuxemon/gfx/sprites/battle/potturmeist-sheet.png`
- `upstream/mods/tuxemon/gfx/sprites/battle/potturney-sheet.png`
...
- [ ] `MonsterDef` entry for **potturmeist** in `src/game/data/monsters.ts`
- [ ] `MonsterDef` entry for **potturney** in `src/game/data/monsters.ts`
- [ ] Battle sprite present at `public/assets/sprites/battle/potturmeist-sheet.png`
- [ ] Battle sprite present at `public/assets/sprites/battle/potturney-sheet.png`
