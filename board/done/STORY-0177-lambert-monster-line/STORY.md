# STORY-0177: Lambert monster line

## Description

Port the lambert-line evolution line from upstream Tuxemon into Arithmon. This is a content-only story — the monster engine (types, stats, moves, evolution, combat) is in place; this story registers the species in our data layer and copies the sprite assets.

The chain contains 3 monsters:
- **lambert** (basic, sprite, wood) — evolves into legko at see upstream YAML
- **legko** (stage1, serpent, wood) — evolves into moloch at level 24
- **moloch** (stage2, brute, wood/heroic) — evolves from legko

### Upstream reference

- `upstream/mods/tuxemon/db/monster/lambert.yaml`
- `upstream/mods/tuxemon/db/monster/legko.yaml`
- `upstream/mods/tuxemon/db/monster/moloch.yaml`
- Sprites:
- `upstream/mods/tuxemon/gfx/sprites/battle/lambert-sheet.png`
- `upstream/mods/tuxemon/gfx/sprites/battle/legko-sheet.png`
- `upstream/mods/tuxemon/gfx/sprites/battle/moloch-sheet.png`
...
- [ ] `MonsterDef` entry for **lambert** in `src/game/data/monsters.ts`
- [ ] `MonsterDef` entry for **legko** in `src/game/data/monsters.ts`
- [ ] `MonsterDef` entry for **moloch** in `src/game/data/monsters.ts`
- [ ] Battle sprite present at `public/assets/sprites/battle/lambert-sheet.png`
- [ ] Battle sprite present at `public/assets/sprites/battle/legko-sheet.png`
- [ ] Battle sprite present at `public/assets/sprites/battle/moloch-sheet.png`
