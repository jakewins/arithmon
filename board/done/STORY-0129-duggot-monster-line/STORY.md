# STORY-0129: Duggot monster line

## Description

Port the duggot-line evolution line from upstream Tuxemon into Arithmon. This is a content-only story — the monster engine (types, stats, moves, evolution, combat) is in place; this story registers the species in our data layer and copies the sprite assets.

The chain contains 2 monsters:
- **duggot** (basic, varmint, wood/venom) — evolves into breem at see upstream YAML
- **breem** (stage1, flier, venom) — evolves from duggot

### Upstream reference

- `upstream/mods/tuxemon/db/monster/duggot.yaml`
- `upstream/mods/tuxemon/db/monster/breem.yaml`
- Sprites:
- `upstream/mods/tuxemon/gfx/sprites/battle/duggot-sheet.png`
- `upstream/mods/tuxemon/gfx/sprites/battle/breem-sheet.png`
...
- [ ] `MonsterDef` entry for **duggot** in `src/game/data/monsters.ts`
- [ ] `MonsterDef` entry for **breem** in `src/game/data/monsters.ts`
- [ ] Battle sprite present at `public/assets/sprites/battle/duggot-sheet.png`
- [ ] Battle sprite present at `public/assets/sprites/battle/breem-sheet.png`
