# STORY-0135: Foxfire monster line

## Description

Port the foxfire-line evolution line from upstream Tuxemon into Arithmon. This is a content-only story — the monster engine (types, stats, moves, evolution, combat) is in place; this story registers the species in our data layer and copies the sprite assets.

The chain contains 2 monsters:
- **foxfire** (basic, varmint, fire) — evolves into vulpyre at see upstream YAML
- **vulpyre** (stage1, hunter, fire) — evolves from foxfire

### Upstream reference

- `upstream/mods/tuxemon/db/monster/foxfire.yaml`
- `upstream/mods/tuxemon/db/monster/vulpyre.yaml`
- Sprites:
- `upstream/mods/tuxemon/gfx/sprites/battle/foxfire-sheet.png`
- `upstream/mods/tuxemon/gfx/sprites/battle/vulpyre-sheet.png`
...
- [ ] `MonsterDef` entry for **foxfire** in `src/game/data/monsters.ts`
- [ ] `MonsterDef` entry for **vulpyre** in `src/game/data/monsters.ts`
- [ ] Battle sprite present at `public/assets/sprites/battle/foxfire-sheet.png`
- [ ] Battle sprite present at `public/assets/sprites/battle/vulpyre-sheet.png`
