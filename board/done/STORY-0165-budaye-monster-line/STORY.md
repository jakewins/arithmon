# STORY-0165: Budaye monster line

## Description

Port the budaye-line evolution line from upstream Tuxemon into Arithmon. This is a content-only story — the monster engine (types, stats, moves, evolution, combat) is in place; this story registers the species in our data layer and copies the sprite assets.

The chain contains 3 monsters:
- **budaye** (basic, sprite, wood) — evolves into bamboon;bamboon;frondly;frondly at see upstream YAML
- **bamboon** (stage1, sprite, wood/heroic) — evolves from budaye;budaye
- **frondly** (stage1, sprite, wood/cosmic) — evolves from budaye;budaye
...
- `upstream/mods/tuxemon/db/monster/budaye.yaml`
- `upstream/mods/tuxemon/db/monster/bamboon.yaml`
- `upstream/mods/tuxemon/db/monster/frondly.yaml`
- Sprites:
- `upstream/mods/tuxemon/gfx/sprites/battle/budaye-sheet.png`
- `upstream/mods/tuxemon/gfx/sprites/battle/bamboon-sheet.png`
- `upstream/mods/tuxemon/gfx/sprites/battle/frondly-sheet.png`
...
- [ ] `MonsterDef` entry for **budaye** in `src/game/data/monsters.ts`
- [ ] `MonsterDef` entry for **bamboon** in `src/game/data/monsters.ts`
- [ ] `MonsterDef` entry for **frondly** in `src/game/data/monsters.ts`
- [ ] Battle sprite present at `public/assets/sprites/battle/budaye-sheet.png`
- [ ] Battle sprite present at `public/assets/sprites/battle/bamboon-sheet.png`
- [ ] Battle sprite present at `public/assets/sprites/battle/frondly-sheet.png`
