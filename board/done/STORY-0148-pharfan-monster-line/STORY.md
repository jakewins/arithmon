# STORY-0148: Pharfan monster line

## Description

Port the pharfan-line evolution line from upstream Tuxemon into Arithmon. This is a content-only story — the monster engine (types, stats, moves, evolution, combat) is in place; this story registers the species in our data layer and copies the sprite assets.

The chain contains 2 monsters:
- **pharfan** (basic, landrace, water) — evolves into pharavion at see upstream YAML
- **pharavion** (stage1, landrace, water/heroic) — evolves from pharfan

### Upstream reference

- `upstream/mods/tuxemon/db/monster/pharfan.yaml`
- `upstream/mods/tuxemon/db/monster/pharavion.yaml`
- Sprites:
- `upstream/mods/tuxemon/gfx/sprites/battle/pharfan-sheet.png`
- `upstream/mods/tuxemon/gfx/sprites/battle/pharavion-sheet.png`
...
- [ ] `MonsterDef` entry for **pharfan** in `src/game/data/monsters.ts`
- [ ] `MonsterDef` entry for **pharavion** in `src/game/data/monsters.ts`
- [ ] Battle sprite present at `public/assets/sprites/battle/pharfan-sheet.png`
- [ ] Battle sprite present at `public/assets/sprites/battle/pharavion-sheet.png`
