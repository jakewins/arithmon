# STORY-0185: Dollfin monster line

## Description

Port the dollfin-line evolution line from upstream Tuxemon into Arithmon. This is a content-only story — the monster engine (types, stats, moves, evolution, combat) is in place; this story registers the species in our data layer and copies the sprite assets.

The chain contains 4 monsters:
- **dollfin** (basic, leviathan, water) — evolves into bigfin;bigfin;sharpfin;sharpfin;delfeco at see upstream YAML
- **bigfin** (stage1, leviathan, water) — evolves from dollfin;dollfin
- **delfeco** (stage1, piscine, water/wood) — evolves from dollfin
- **sharpfin** (stage1, piscine, water/heroic) — evolves from dollfin;dollfin
...
- `upstream/mods/tuxemon/db/monster/dollfin.yaml`
- `upstream/mods/tuxemon/db/monster/bigfin.yaml`
- `upstream/mods/tuxemon/db/monster/delfeco.yaml`
- `upstream/mods/tuxemon/db/monster/sharpfin.yaml`
- Sprites:
- `upstream/mods/tuxemon/gfx/sprites/battle/dollfin-sheet.png`
- `upstream/mods/tuxemon/gfx/sprites/battle/bigfin-sheet.png`
- `upstream/mods/tuxemon/gfx/sprites/battle/delfeco-sheet.png`
- `upstream/mods/tuxemon/gfx/sprites/battle/sharpfin-sheet.png`
...
- [ ] `MonsterDef` entry for **dollfin** in `src/game/data/monsters.ts`
- [ ] `MonsterDef` entry for **bigfin** in `src/game/data/monsters.ts`
- [ ] `MonsterDef` entry for **delfeco** in `src/game/data/monsters.ts`
- [ ] `MonsterDef` entry for **sharpfin** in `src/game/data/monsters.ts`
- [ ] Battle sprite present at `public/assets/sprites/battle/dollfin-sheet.png`
- [ ] Battle sprite present at `public/assets/sprites/battle/bigfin-sheet.png`
- [ ] Battle sprite present at `public/assets/sprites/battle/delfeco-sheet.png`
- [ ] Battle sprite present at `public/assets/sprites/battle/sharpfin-sheet.png`
