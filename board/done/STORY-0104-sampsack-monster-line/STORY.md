# STORY-0104: Sampsack monster line

## Description

Port the sampsack-line evolution line from upstream Tuxemon into Arithmon. This is a content-only story — the monster engine (types, stats, moves, evolution, combat) is in place; this story registers the species in our data layer and copies the sprite assets.

The chain contains 1 monster:
- **sampsack** (standalone — does not evolve, brute, heroic) — terminal (no evolution)

### Upstream reference

- `upstream/mods/tuxemon/db/monster/sampsack.yaml`
- Sprites:
- `upstream/mods/tuxemon/gfx/sprites/battle/sampsack-sheet.png`
...
- [ ] `MonsterDef` entry for **sampsack** in `src/game/data/monsters.ts`
- [ ] Battle sprite present at `public/assets/sprites/battle/sampsack-sheet.png`
