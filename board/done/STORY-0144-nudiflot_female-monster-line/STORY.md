# STORY-0144: Nudiflot_female monster line

## Description

Port the nudiflot_female-line evolution line from upstream Tuxemon into Arithmon. This is a content-only story — the monster engine (types, stats, moves, evolution, combat) is in place; this story registers the species in our data layer and copies the sprite assets.

The chain contains 2 monsters:
- **nudiflot_female** (basic, polliwog, water/cosmic) — evolves into nudimind at see upstream YAML
- **nudimind** (stage1, polliwog, water/cosmic) — evolves from nudiflot_female

### Upstream reference

- `upstream/mods/tuxemon/db/monster/nudiflot_female.yaml`
- `upstream/mods/tuxemon/db/monster/nudimind.yaml`
- Sprites:
- `upstream/mods/tuxemon/gfx/sprites/battle/nudiflot_female-sheet.png`
- `upstream/mods/tuxemon/gfx/sprites/battle/nudimind-sheet.png`
...
- [ ] `MonsterDef` entry for **nudiflot_female** in `src/game/data/monsters.ts`
- [ ] `MonsterDef` entry for **nudimind** in `src/game/data/monsters.ts`
- [ ] Battle sprite present at `public/assets/sprites/battle/nudiflot_female-sheet.png`
- [ ] Battle sprite present at `public/assets/sprites/battle/nudimind-sheet.png`
