# STORY-0145: Nudiflot_male monster line

## Description

Port the nudiflot_male-line evolution line from upstream Tuxemon into Arithmon. This is a content-only story — the monster engine (types, stats, moves, evolution, combat) is in place; this story registers the species in our data layer and copies the sprite assets.

The chain contains 2 monsters:
- **nudiflot_male** (basic, polliwog, water/venom) — evolves into nudikill at see upstream YAML
- **nudikill** (stage1, polliwog, water/venom) — evolves from nudiflot_male

### Upstream reference

- `upstream/mods/tuxemon/db/monster/nudiflot_male.yaml`
- `upstream/mods/tuxemon/db/monster/nudikill.yaml`
- Sprites:
- `upstream/mods/tuxemon/gfx/sprites/battle/nudiflot_male-sheet.png`
- `upstream/mods/tuxemon/gfx/sprites/battle/nudikill-sheet.png`
...
- [ ] `MonsterDef` entry for **nudiflot_male** in `src/game/data/monsters.ts`
- [ ] `MonsterDef` entry for **nudikill** in `src/game/data/monsters.ts`
- [ ] Battle sprite present at `public/assets/sprites/battle/nudiflot_male-sheet.png`
- [ ] Battle sprite present at `public/assets/sprites/battle/nudikill-sheet.png`
