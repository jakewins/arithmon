# STORY-0158: Thumpurn monster line

## Description

Port the thumpurn-line evolution line from upstream Tuxemon into Arithmon. This is a content-only story — the monster engine (types, stats, moves, evolution, combat) is in place; this story registers the species in our data layer and copies the sprite assets.

The chain contains 2 monsters:
- **thumpurn** (basic, brute, fire/normal) — evolves into volconey at see upstream YAML
- **volconey** (stage1, varmint, fire/normal) — evolves from thumpurn

### Upstream reference

- `upstream/mods/tuxemon/db/monster/thumpurn.yaml`
- `upstream/mods/tuxemon/db/monster/volconey.yaml`
- Sprites:
- `upstream/mods/tuxemon/gfx/sprites/battle/thumpurn-sheet.png`
- `upstream/mods/tuxemon/gfx/sprites/battle/volconey-sheet.png`
...
- [ ] `MonsterDef` entry for **thumpurn** in `src/game/data/monsters.ts`
- [ ] `MonsterDef` entry for **volconey** in `src/game/data/monsters.ts`
- [ ] Battle sprite present at `public/assets/sprites/battle/thumpurn-sheet.png`
- [ ] Battle sprite present at `public/assets/sprites/battle/volconey-sheet.png`
