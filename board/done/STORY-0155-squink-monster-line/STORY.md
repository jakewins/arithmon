# STORY-0155: Squink monster line

## Description

Port the squink-line evolution line from upstream Tuxemon into Arithmon. This is a content-only story — the monster engine (types, stats, moves, evolution, combat) is in place; this story registers the species in our data layer and copies the sprite assets.

The chain contains 2 monsters:
- **squink** (basic, polliwog, water) — evolves into hectapod at see upstream YAML
- **hectapod** (stage1, polliwog, water) — evolves from squink

### Upstream reference

- `upstream/mods/tuxemon/db/monster/squink.yaml`
- `upstream/mods/tuxemon/db/monster/hectapod.yaml`
- Sprites:
- `upstream/mods/tuxemon/gfx/sprites/battle/squink-sheet.png`
- `upstream/mods/tuxemon/gfx/sprites/battle/hectapod-sheet.png`
...
- [ ] `MonsterDef` entry for **squink** in `src/game/data/monsters.ts`
- [ ] `MonsterDef` entry for **hectapod** in `src/game/data/monsters.ts`
- [ ] Battle sprite present at `public/assets/sprites/battle/squink-sheet.png`
- [ ] Battle sprite present at `public/assets/sprites/battle/hectapod-sheet.png`
