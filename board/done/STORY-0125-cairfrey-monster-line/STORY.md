# STORY-0125: Cairfrey monster line

## Description

Port the cairfrey-line evolution line from upstream Tuxemon into Arithmon. This is a content-only story — the monster engine (types, stats, moves, evolution, combat) is in place; this story registers the species in our data layer and copies the sprite assets.

The chain contains 2 monsters:
- **cairfrey** (basic, blob, normal) — evolves into possessun at see upstream YAML
- **possessun** (stage1, blob, shadow) — evolves from cairfrey

### Upstream reference

- `upstream/mods/tuxemon/db/monster/cairfrey.yaml`
- `upstream/mods/tuxemon/db/monster/possessun.yaml`
- Sprites:
- `upstream/mods/tuxemon/gfx/sprites/battle/cairfrey-sheet.png`
- `upstream/mods/tuxemon/gfx/sprites/battle/possessun-sheet.png`
...
- [ ] `MonsterDef` entry for **cairfrey** in `src/game/data/monsters.ts`
- [ ] `MonsterDef` entry for **possessun** in `src/game/data/monsters.ts`
- [ ] Battle sprite present at `public/assets/sprites/battle/cairfrey-sheet.png`
- [ ] Battle sprite present at `public/assets/sprites/battle/possessun-sheet.png`
