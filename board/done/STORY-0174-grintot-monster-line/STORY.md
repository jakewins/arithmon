# STORY-0174: Grintot monster line

## Description

Port the grintot-line evolution line from upstream Tuxemon into Arithmon. This is a content-only story — the monster engine (types, stats, moves, evolution, combat) is in place; this story registers the species in our data layer and copies the sprite assets.

The chain contains 3 monsters:
- **grintot** (basic, brute, earth) — evolves into grinflare;grinflare;grintrock;grintrock at see upstream YAML
- **grinflare** (stage1, brute, earth/fire) — evolves from grintot;grintot
- **grintrock** (stage1, brute, lightning/earth) — evolves from grintot;grintot
...
- `upstream/mods/tuxemon/db/monster/grintot.yaml`
- `upstream/mods/tuxemon/db/monster/grinflare.yaml`
- `upstream/mods/tuxemon/db/monster/grintrock.yaml`
- Sprites:
- `upstream/mods/tuxemon/gfx/sprites/battle/grintot-sheet.png`
- `upstream/mods/tuxemon/gfx/sprites/battle/grinflare-sheet.png`
- `upstream/mods/tuxemon/gfx/sprites/battle/grintrock-sheet.png`
...
- [ ] `MonsterDef` entry for **grintot** in `src/game/data/monsters.ts`
- [ ] `MonsterDef` entry for **grinflare** in `src/game/data/monsters.ts`
- [ ] `MonsterDef` entry for **grintrock** in `src/game/data/monsters.ts`
- [ ] Battle sprite present at `public/assets/sprites/battle/grintot-sheet.png`
- [ ] Battle sprite present at `public/assets/sprites/battle/grinflare-sheet.png`
- [ ] Battle sprite present at `public/assets/sprites/battle/grintrock-sheet.png`
