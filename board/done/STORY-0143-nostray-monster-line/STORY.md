# STORY-0143: Nostray monster line

## Description

Port the nostray-line evolution line from upstream Tuxemon into Arithmon. This is a content-only story — the monster engine (types, stats, moves, evolution, combat) is in place; this story registers the species in our data layer and copies the sprite assets.

The chain contains 2 monsters:
- **nostray** (basic, piscine, water) — evolves into shnark at see upstream YAML
- **shnark** (stage1, piscine, water) — evolves from nostray

### Upstream reference

- `upstream/mods/tuxemon/db/monster/nostray.yaml`
- `upstream/mods/tuxemon/db/monster/shnark.yaml`
- Sprites:
- `upstream/mods/tuxemon/gfx/sprites/battle/nostray-sheet.png`
- `upstream/mods/tuxemon/gfx/sprites/battle/shnark-sheet.png`
...
- [ ] `MonsterDef` entry for **nostray** in `src/game/data/monsters.ts`
- [ ] `MonsterDef` entry for **shnark** in `src/game/data/monsters.ts`
- [ ] Battle sprite present at `public/assets/sprites/battle/nostray-sheet.png`
- [ ] Battle sprite present at `public/assets/sprites/battle/shnark-sheet.png`
