# STORY-0091: Hampotamos monster line

## Description

Port the hampotamos-line evolution line from upstream Tuxemon into Arithmon. This is a content-only story — the monster engine (types, stats, moves, evolution, combat) is in place; this story registers the species in our data layer and copies the sprite assets.

The chain contains 1 monster:
- **hampotamos** (standalone — does not evolve, landrace, earth) — terminal (no evolution)

### Upstream reference

- `upstream/mods/tuxemon/db/monster/hampotamos.yaml`
- Sprites:
- `upstream/mods/tuxemon/gfx/sprites/battle/hampotamos-sheet.png`
...
- [ ] `MonsterDef` entry for **hampotamos** in `src/game/data/monsters.ts`
- [ ] Battle sprite present at `public/assets/sprites/battle/hampotamos-sheet.png`
