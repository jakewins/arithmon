# STORY-0181: Stonifly monster line

## Description

Port the stonifly-line evolution line from upstream Tuxemon into Arithmon. This is a content-only story — the monster engine (types, stats, moves, evolution, combat) is in place; this story registers the species in our data layer and copies the sprite assets.

The chain contains 3 monsters:
- **stonifly** (basic, grub, earth) — evolves into cocrune at see upstream YAML
- **cocrune** (stage1, blob, earth/shadow) — evolves into runesquito at level 9
- **runesquito** (stage2, flier, earth/shadow) — evolves from cocrune

### Upstream reference

- `upstream/mods/tuxemon/db/monster/stonifly.yaml`
- `upstream/mods/tuxemon/db/monster/cocrune.yaml`
- `upstream/mods/tuxemon/db/monster/runesquito.yaml`
- Sprites:
- `upstream/mods/tuxemon/gfx/sprites/battle/stonifly-sheet.png`
- `upstream/mods/tuxemon/gfx/sprites/battle/cocrune-sheet.png`
- `upstream/mods/tuxemon/gfx/sprites/battle/runesquito-sheet.png`
...
- [ ] `MonsterDef` entry for **stonifly** in `src/game/data/monsters.ts`
- [ ] `MonsterDef` entry for **cocrune** in `src/game/data/monsters.ts`
- [ ] `MonsterDef` entry for **runesquito** in `src/game/data/monsters.ts`
- [ ] Battle sprite present at `public/assets/sprites/battle/stonifly-sheet.png`
- [ ] Battle sprite present at `public/assets/sprites/battle/cocrune-sheet.png`
- [ ] Battle sprite present at `public/assets/sprites/battle/runesquito-sheet.png`
