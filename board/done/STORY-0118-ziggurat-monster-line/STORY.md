# STORY-0118: Ziggurat monster line

## Description

Port the ziggurat-line evolution line from upstream Tuxemon into Arithmon. This is a content-only story — the monster engine (types, stats, moves, evolution, combat) is in place; this story registers the species in our data layer and copies the sprite assets.

The chain contains 1 monster:
- **ziggurat** (standalone — does not evolve, varmint, earth/normal) — terminal (no evolution)

### Upstream reference

- `upstream/mods/tuxemon/db/monster/ziggurat.yaml`
- Sprites:
- `upstream/mods/tuxemon/gfx/sprites/battle/ziggurat-sheet.png`
...
- [ ] `MonsterDef` entry for **ziggurat** in `src/game/data/monsters.ts`
- [ ] Battle sprite present at `public/assets/sprites/battle/ziggurat-sheet.png`
