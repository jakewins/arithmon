# STORY-0080: Conifrost monster line

## Description

Port the conifrost-line evolution line from upstream Tuxemon into Arithmon. This is a content-only story — the monster engine (types, stats, moves, evolution, combat) is in place; this story registers the species in our data layer and copies the sprite assets.

The chain contains 1 monster:
- **conifrost** (standalone — does not evolve, blob, wood/frost) — terminal (no evolution)

### Upstream reference

- `upstream/mods/tuxemon/db/monster/conifrost.yaml`
- Sprites:
- `upstream/mods/tuxemon/gfx/sprites/battle/conifrost-sheet.png`
...
- [ ] `MonsterDef` entry for **conifrost** in `src/game/data/monsters.ts`
- [ ] Battle sprite present at `public/assets/sprites/battle/conifrost-sheet.png`
