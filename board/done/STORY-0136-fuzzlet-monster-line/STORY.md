# STORY-0136: Fuzzlet monster line

## Description

Port the fuzzlet-line evolution line from upstream Tuxemon into Arithmon. This is a content-only story — the monster engine (types, stats, moves, evolution, combat) is in place; this story registers the species in our data layer and copies the sprite assets.

The chain contains 2 monsters:
- **fuzzlet** (basic, blob, cosmic/normal) — evolves into fuzzina at see upstream YAML
- **fuzzina** (stage1, blob, cosmic/normal) — evolves from fuzzlet

### Upstream reference

- `upstream/mods/tuxemon/db/monster/fuzzlet.yaml`
- `upstream/mods/tuxemon/db/monster/fuzzina.yaml`
- Sprites:
- `upstream/mods/tuxemon/gfx/sprites/battle/fuzzlet-sheet.png`
- `upstream/mods/tuxemon/gfx/sprites/battle/fuzzina-sheet.png`
...
- [ ] `MonsterDef` entry for **fuzzlet** in `src/game/data/monsters.ts`
- [ ] `MonsterDef` entry for **fuzzina** in `src/game/data/monsters.ts`
- [ ] Battle sprite present at `public/assets/sprites/battle/fuzzlet-sheet.png`
- [ ] Battle sprite present at `public/assets/sprites/battle/fuzzina-sheet.png`
