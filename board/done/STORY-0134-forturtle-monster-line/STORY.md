# STORY-0134: Forturtle monster line

## Description

Port the forturtle-line evolution line from upstream Tuxemon into Arithmon. This is a content-only story — the monster engine (types, stats, moves, evolution, combat) is in place; this story registers the species in our data layer and copies the sprite assets.

The chain contains 2 monsters:
- **forturtle** (basic, humanoid, cosmic) — evolves into prophetoise at see upstream YAML
- **prophetoise** (stage1, humanoid, fire/cosmic) — evolves from forturtle

### Upstream reference

- `upstream/mods/tuxemon/db/monster/forturtle.yaml`
- `upstream/mods/tuxemon/db/monster/prophetoise.yaml`
- Sprites:
- `upstream/mods/tuxemon/gfx/sprites/battle/forturtle-sheet.png`
- `upstream/mods/tuxemon/gfx/sprites/battle/prophetoise-sheet.png`
...
- [ ] `MonsterDef` entry for **forturtle** in `src/game/data/monsters.ts`
- [ ] `MonsterDef` entry for **prophetoise** in `src/game/data/monsters.ts`
- [ ] Battle sprite present at `public/assets/sprites/battle/forturtle-sheet.png`
- [ ] Battle sprite present at `public/assets/sprites/battle/prophetoise-sheet.png`
