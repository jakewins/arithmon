# STORY-0184: Wrougon monster line

## Description

Port the wrougon-line evolution line from upstream Tuxemon into Arithmon. This is a content-only story — the monster engine (types, stats, moves, evolution, combat) is in place; this story registers the species in our data layer and copies the sprite assets.

The chain contains 3 monsters:
- **wrougon** (basic, dragon, metal) — evolves into allagon at see upstream YAML
- **allagon** (stage1, dragon, metal) — evolves into ferricran at level 32
- **ferricran** (stage2, dragon, metal) — evolves from allagon

### Upstream reference

- `upstream/mods/tuxemon/db/monster/wrougon.yaml`
- `upstream/mods/tuxemon/db/monster/allagon.yaml`
- `upstream/mods/tuxemon/db/monster/ferricran.yaml`
- Sprites:
- `upstream/mods/tuxemon/gfx/sprites/battle/wrougon-sheet.png`
- `upstream/mods/tuxemon/gfx/sprites/battle/allagon-sheet.png`
- `upstream/mods/tuxemon/gfx/sprites/battle/ferricran-sheet.png`
...
- [ ] `MonsterDef` entry for **wrougon** in `src/game/data/monsters.ts`
- [ ] `MonsterDef` entry for **allagon** in `src/game/data/monsters.ts`
- [ ] `MonsterDef` entry for **ferricran** in `src/game/data/monsters.ts`
- [ ] Battle sprite present at `public/assets/sprites/battle/wrougon-sheet.png`
- [ ] Battle sprite present at `public/assets/sprites/battle/allagon-sheet.png`
- [ ] Battle sprite present at `public/assets/sprites/battle/ferricran-sheet.png`
