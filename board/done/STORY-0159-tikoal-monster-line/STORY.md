# STORY-0159: Tikoal monster line

## Description

Port the tikoal-line evolution line from upstream Tuxemon into Arithmon. This is a content-only story — the monster engine (types, stats, moves, evolution, combat) is in place; this story registers the species in our data layer and copies the sprite assets.

The chain contains 2 monsters:
- **tikoal** (basic, blob, wood/fire) — evolves into tikorch at see upstream YAML
- **tikorch** (stage1, blob, wood/fire) — evolves from tikoal

### Upstream reference

- `upstream/mods/tuxemon/db/monster/tikoal.yaml`
- `upstream/mods/tuxemon/db/monster/tikorch.yaml`
- Sprites:
- `upstream/mods/tuxemon/gfx/sprites/battle/tikoal-sheet.png`
- `upstream/mods/tuxemon/gfx/sprites/battle/tikorch-sheet.png`
...
- [ ] `MonsterDef` entry for **tikoal** in `src/game/data/monsters.ts`
- [ ] `MonsterDef` entry for **tikorch** in `src/game/data/monsters.ts`
- [ ] Battle sprite present at `public/assets/sprites/battle/tikoal-sheet.png`
- [ ] Battle sprite present at `public/assets/sprites/battle/tikorch-sheet.png`
