# STORY-0105: Sampsage monster line

## Description

Port the sampsage-line evolution line from upstream Tuxemon into Arithmon. This is a content-only story — the monster engine (types, stats, moves, evolution, combat) is in place; this story registers the species in our data layer and copies the sprite assets.

The chain contains 1 monster:
- **sampsage** (standalone — does not evolve, humanoid, cosmic) — terminal (no evolution)

### Upstream reference

- `upstream/mods/tuxemon/db/monster/sampsage.yaml`
- Sprites:
- `upstream/mods/tuxemon/gfx/sprites/battle/sampsage-sheet.png`
...
- [ ] `MonsterDef` entry for **sampsage** in `src/game/data/monsters.ts`
- [ ] Battle sprite present at `public/assets/sprites/battle/sampsage-sheet.png`
