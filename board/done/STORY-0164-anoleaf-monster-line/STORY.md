# STORY-0164: Anoleaf monster line

## Description

Port the anoleaf-line evolution line from upstream Tuxemon into Arithmon. This is a content-only story — the monster engine (types, stats, moves, evolution, combat) is in place; this story registers the species in our data layer and copies the sprite assets.

The chain contains 3 monsters:
- **anoleaf** (basic, varmint, wood) — evolves into gectile at see upstream YAML
- **gectile** (stage1, humanoid, wood) — evolves into velocitile at level 18
- **velocitile** (stage2, humanoid, wood) — evolves from gectile

### Upstream reference

- `upstream/mods/tuxemon/db/monster/anoleaf.yaml`
- `upstream/mods/tuxemon/db/monster/gectile.yaml`
- `upstream/mods/tuxemon/db/monster/velocitile.yaml`
- Sprites:
- `upstream/mods/tuxemon/gfx/sprites/battle/anoleaf-sheet.png`
- `upstream/mods/tuxemon/gfx/sprites/battle/gectile-sheet.png`
- `upstream/mods/tuxemon/gfx/sprites/battle/velocitile-sheet.png`
...
- [ ] `MonsterDef` entry for **anoleaf** in `src/game/data/monsters.ts`
- [ ] `MonsterDef` entry for **gectile** in `src/game/data/monsters.ts`
- [ ] `MonsterDef` entry for **velocitile** in `src/game/data/monsters.ts`
- [ ] Battle sprite present at `public/assets/sprites/battle/anoleaf-sheet.png`
- [ ] Battle sprite present at `public/assets/sprites/battle/gectile-sheet.png`
- [ ] Battle sprite present at `public/assets/sprites/battle/velocitile-sheet.png`
