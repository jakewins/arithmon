# STORY-0103: Rocktot monster line

## Description

Port the rocktot-line evolution line from upstream Tuxemon into Arithmon. This is a content-only story — the monster engine (types, stats, moves, evolution, combat) is in place; this story registers the species in our data layer and copies the sprite assets.

The chain contains 1 monster:
- **rocktot** (standalone — does not evolve, brute, earth) — terminal (no evolution)

### Upstream reference

- `upstream/mods/tuxemon/db/monster/rocktot.yaml`
- Sprites:
- `upstream/mods/tuxemon/gfx/sprites/battle/rocktot-sheet.png`
...
- [ ] `MonsterDef` entry for **rocktot** in `src/game/data/monsters.ts`
- [ ] Battle sprite present at `public/assets/sprites/battle/rocktot-sheet.png`
