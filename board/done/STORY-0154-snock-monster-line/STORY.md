# STORY-0154: Snock monster line

## Description

Port the snock-line evolution line from upstream Tuxemon into Arithmon. This is a content-only story — the monster engine (types, stats, moves, evolution, combat) is in place; this story registers the species in our data layer and copies the sprite assets.

The chain contains 2 monsters:
- **snock** (basic, serpent, normal) — evolves into pythock at see upstream YAML
- **pythock** (stage1, serpent, shadow/normal) — evolves from snock

### Upstream reference

- `upstream/mods/tuxemon/db/monster/snock.yaml`
- `upstream/mods/tuxemon/db/monster/pythock.yaml`
- Sprites:
- `upstream/mods/tuxemon/gfx/sprites/battle/snock-sheet.png`
- `upstream/mods/tuxemon/gfx/sprites/battle/pythock-sheet.png`
...
- [ ] `MonsterDef` entry for **snock** in `src/game/data/monsters.ts`
- [ ] `MonsterDef` entry for **pythock** in `src/game/data/monsters.ts`
- [ ] Battle sprite present at `public/assets/sprites/battle/snock-sheet.png`
- [ ] Battle sprite present at `public/assets/sprites/battle/pythock-sheet.png`
