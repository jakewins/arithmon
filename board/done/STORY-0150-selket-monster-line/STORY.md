# STORY-0150: Selket monster line

## Description

Port the selket-line evolution line from upstream Tuxemon into Arithmon. This is a content-only story — the monster engine (types, stats, moves, evolution, combat) is in place; this story registers the species in our data layer and copies the sprite assets.

The chain contains 2 monsters:
- **selket** (basic, grub, earth/venom) — evolves into selmatek at see upstream YAML
- **selmatek** (stage1, grub, earth/venom) — evolves from selket

### Upstream reference

- `upstream/mods/tuxemon/db/monster/selket.yaml`
- `upstream/mods/tuxemon/db/monster/selmatek.yaml`
- Sprites:
- `upstream/mods/tuxemon/gfx/sprites/battle/selket-sheet.png`
- `upstream/mods/tuxemon/gfx/sprites/battle/selmatek-sheet.png`
...
- [ ] `MonsterDef` entry for **selket** in `src/game/data/monsters.ts`
- [ ] `MonsterDef` entry for **selmatek** in `src/game/data/monsters.ts`
- [ ] Battle sprite present at `public/assets/sprites/battle/selket-sheet.png`
- [ ] Battle sprite present at `public/assets/sprites/battle/selmatek-sheet.png`
