# STORY-0139: Komodraw monster line

## Description

Port the komodraw-line evolution line from upstream Tuxemon into Arithmon. This is a content-only story — the monster engine (types, stats, moves, evolution, combat) is in place; this story registers the species in our data layer and copies the sprite assets.

The chain contains 2 monsters:
- **komodraw** (basic, humanoid, normal) — evolves into komoduel at see upstream YAML
- **komoduel** (stage1, humanoid, normal) — evolves from komodraw

### Upstream reference

- `upstream/mods/tuxemon/db/monster/komodraw.yaml`
- `upstream/mods/tuxemon/db/monster/komoduel.yaml`
- Sprites:
- `upstream/mods/tuxemon/gfx/sprites/battle/komodraw-sheet.png`
- `upstream/mods/tuxemon/gfx/sprites/battle/komoduel-sheet.png`
...
- [ ] `MonsterDef` entry for **komodraw** in `src/game/data/monsters.ts`
- [ ] `MonsterDef` entry for **komoduel** in `src/game/data/monsters.ts`
- [ ] Battle sprite present at `public/assets/sprites/battle/komodraw-sheet.png`
- [ ] Battle sprite present at `public/assets/sprites/battle/komoduel-sheet.png`
