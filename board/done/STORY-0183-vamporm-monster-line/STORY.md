# STORY-0183: Vamporm monster line

## Description

Port the vamporm-line evolution line from upstream Tuxemon into Arithmon. This is a content-only story — the monster engine (types, stats, moves, evolution, combat) is in place; this story registers the species in our data layer and copies the sprite assets.

The chain contains 3 monsters:
- **vamporm** (basic, grub, venom/shadow) — evolves into dracune at see upstream YAML
- **dracune** (stage1, blob, venom/shadow) — evolves into fluttaflap at level 9
- **fluttaflap** (stage2, grub, sky/shadow) — evolves from dracune

### Upstream reference

- `upstream/mods/tuxemon/db/monster/vamporm.yaml`
- `upstream/mods/tuxemon/db/monster/dracune.yaml`
- `upstream/mods/tuxemon/db/monster/fluttaflap.yaml`
- Sprites:
- `upstream/mods/tuxemon/gfx/sprites/battle/vamporm-sheet.png`
- `upstream/mods/tuxemon/gfx/sprites/battle/dracune-sheet.png`
- `upstream/mods/tuxemon/gfx/sprites/battle/fluttaflap-sheet.png`
...
- [ ] `MonsterDef` entry for **vamporm** in `src/game/data/monsters.ts`
- [ ] `MonsterDef` entry for **dracune** in `src/game/data/monsters.ts`
- [ ] `MonsterDef` entry for **fluttaflap** in `src/game/data/monsters.ts`
- [ ] Battle sprite present at `public/assets/sprites/battle/vamporm-sheet.png`
- [ ] Battle sprite present at `public/assets/sprites/battle/dracune-sheet.png`
- [ ] Battle sprite present at `public/assets/sprites/battle/fluttaflap-sheet.png`
