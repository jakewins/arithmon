# STORY-0111: Spycozeus monster line

## Description

Port the spycozeus-line evolution line from upstream Tuxemon into Arithmon. This is a content-only story — the monster engine (types, stats, moves, evolution, combat) is in place; this story registers the species in our data layer and copies the sprite assets.

The chain contains 1 monster:
- **spycozeus** (standalone — does not evolve, varmint, wood) — terminal (no evolution)

### Upstream reference

- `upstream/mods/tuxemon/db/monster/spycozeus.yaml`
- Sprites:
- `upstream/mods/tuxemon/gfx/sprites/battle/spycozeus-sheet.png`
...
- [ ] `MonsterDef` entry for **spycozeus** in `src/game/data/monsters.ts`
- [ ] Battle sprite present at `public/assets/sprites/battle/spycozeus-sheet.png`
