# STORY-0166: Cardiling monster line

## Description

Port the cardiling-line evolution line from upstream Tuxemon into Arithmon. This is a content-only story — the monster engine (types, stats, moves, evolution, combat) is in place; this story registers the species in our data layer and copies the sprite assets.

The chain contains 3 monsters:
- **cardiling** (basic, flier, fire/sky) — evolves into cardiwing at see upstream YAML
- **cardiwing** (stage1, flier, fire/sky) — evolves into cardinale at level 18
- **cardinale** (stage2, flier, fire/sky) — evolves from cardiwing

### Upstream reference

- `upstream/mods/tuxemon/db/monster/cardiling.yaml`
- `upstream/mods/tuxemon/db/monster/cardiwing.yaml`
- `upstream/mods/tuxemon/db/monster/cardinale.yaml`
- Sprites:
- `upstream/mods/tuxemon/gfx/sprites/battle/cardiling-sheet.png`
- `upstream/mods/tuxemon/gfx/sprites/battle/cardiwing-sheet.png`
- `upstream/mods/tuxemon/gfx/sprites/battle/cardinale-sheet.png`
...
- [ ] `MonsterDef` entry for **cardiling** in `src/game/data/monsters.ts`
- [ ] `MonsterDef` entry for **cardiwing** in `src/game/data/monsters.ts`
- [ ] `MonsterDef` entry for **cardinale** in `src/game/data/monsters.ts`
- [ ] Battle sprite present at `public/assets/sprites/battle/cardiling-sheet.png`
- [ ] Battle sprite present at `public/assets/sprites/battle/cardiwing-sheet.png`
- [ ] Battle sprite present at `public/assets/sprites/battle/cardinale-sheet.png`
