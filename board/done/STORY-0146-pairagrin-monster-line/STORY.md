# STORY-0146: Pairagrin monster line

## Description

Port the pairagrin-line evolution line from upstream Tuxemon into Arithmon. This is a content-only story — the monster engine (types, stats, moves, evolution, combat) is in place; this story registers the species in our data layer and copies the sprite assets.

The chain contains 2 monsters:
- **pairagrin** (basic, flier, sky) — evolves into pairagrim at see upstream YAML
- **pairagrim** (stage1, flier, sky) — evolves from pairagrin

### Upstream reference

- `upstream/mods/tuxemon/db/monster/pairagrin.yaml`
- `upstream/mods/tuxemon/db/monster/pairagrim.yaml`
- Sprites:
- `upstream/mods/tuxemon/gfx/sprites/battle/pairagrin-sheet.png`
- `upstream/mods/tuxemon/gfx/sprites/battle/pairagrim-sheet.png`
...
- [ ] `MonsterDef` entry for **pairagrin** in `src/game/data/monsters.ts`
- [ ] `MonsterDef` entry for **pairagrim** in `src/game/data/monsters.ts`
- [ ] Battle sprite present at `public/assets/sprites/battle/pairagrin-sheet.png`
- [ ] Battle sprite present at `public/assets/sprites/battle/pairagrim-sheet.png`
