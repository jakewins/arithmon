# STORY-0168: Chloragon monster line

## Description

Port the chloragon-line evolution line from upstream Tuxemon into Arithmon. This is a content-only story — the monster engine (types, stats, moves, evolution, combat) is in place; this story registers the species in our data layer and copies the sprite assets.

The chain contains 3 monsters:
- **chloragon** (basic, dragon, wood) — evolves into sapragon at see upstream YAML
- **sapragon** (stage1, dragon, wood) — evolves into dragarbor at level 32
- **dragarbor** (stage2, dragon, wood/cosmic) — evolves from sapragon

### Upstream reference

- `upstream/mods/tuxemon/db/monster/chloragon.yaml`
- `upstream/mods/tuxemon/db/monster/sapragon.yaml`
- `upstream/mods/tuxemon/db/monster/dragarbor.yaml`
- Sprites:
- `upstream/mods/tuxemon/gfx/sprites/battle/chloragon-sheet.png`
- `upstream/mods/tuxemon/gfx/sprites/battle/sapragon-sheet.png`
- `upstream/mods/tuxemon/gfx/sprites/battle/dragarbor-sheet.png`
...
- [ ] `MonsterDef` entry for **chloragon** in `src/game/data/monsters.ts`
- [ ] `MonsterDef` entry for **sapragon** in `src/game/data/monsters.ts`
- [ ] `MonsterDef` entry for **dragarbor** in `src/game/data/monsters.ts`
- [ ] Battle sprite present at `public/assets/sprites/battle/chloragon-sheet.png`
- [ ] Battle sprite present at `public/assets/sprites/battle/sapragon-sheet.png`
- [ ] Battle sprite present at `public/assets/sprites/battle/dragarbor-sheet.png`
