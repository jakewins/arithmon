# STORY-0084: Drokoro monster line

## Description

Port the drokoro-line evolution line from upstream Tuxemon into Arithmon. This is a content-only story — the monster engine (types, stats, moves, evolution, combat) is in place; this story registers the species in our data layer and copies the sprite assets.

The chain contains 1 monster:
- **drokoro** (standalone — does not evolve, dragon, fire) — terminal (no evolution)

### Upstream reference

- `upstream/mods/tuxemon/db/monster/drokoro.yaml`
- Sprites:
- `upstream/mods/tuxemon/gfx/sprites/battle/drokoro-sheet.png`
...
- [ ] `MonsterDef` entry for **drokoro** in `src/game/data/monsters.ts`
- [ ] Battle sprite present at `public/assets/sprites/battle/drokoro-sheet.png`
