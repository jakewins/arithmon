# STORY-0153: Snaki monster line

## Description

Port the snaki-line evolution line from upstream Tuxemon into Arithmon. This is a content-only story — the monster engine (types, stats, moves, evolution, combat) is in place; this story registers the species in our data layer and copies the sprite assets.

The chain contains 2 monsters:
- **snaki** (basic, serpent, normal) — evolves into snokari at see upstream YAML
- **snokari** (stage1, serpent, normal) — evolves from snaki

### Upstream reference

- `upstream/mods/tuxemon/db/monster/snaki.yaml`
- `upstream/mods/tuxemon/db/monster/snokari.yaml`
- Sprites:
- `upstream/mods/tuxemon/gfx/sprites/battle/snaki-sheet.png`
- `upstream/mods/tuxemon/gfx/sprites/battle/snokari-sheet.png`
...
- [ ] `MonsterDef` entry for **snaki** in `src/game/data/monsters.ts`
- [ ] `MonsterDef` entry for **snokari** in `src/game/data/monsters.ts`
- [ ] Battle sprite present at `public/assets/sprites/battle/snaki-sheet.png`
- [ ] Battle sprite present at `public/assets/sprites/battle/snokari-sheet.png`
