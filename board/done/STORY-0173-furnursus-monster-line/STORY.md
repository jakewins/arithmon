# STORY-0173: Furnursus monster line

## Description

Port the furnursus-line evolution line from upstream Tuxemon into Arithmon. This is a content-only story — the monster engine (types, stats, moves, evolution, combat) is in place; this story registers the species in our data layer and copies the sprite assets.

The chain contains 3 monsters:
- **furnursus** (basic, humanoid, fire) — evolves into statursus at see upstream YAML
- **statursus** (stage1, humanoid, fire/cosmic) — evolves into coaldiak at level 18
- **coaldiak** (stage2, humanoid, fire/normal) — evolves from statursus

### Upstream reference

- `upstream/mods/tuxemon/db/monster/furnursus.yaml`
- `upstream/mods/tuxemon/db/monster/statursus.yaml`
- `upstream/mods/tuxemon/db/monster/coaldiak.yaml`
- Sprites:
- `upstream/mods/tuxemon/gfx/sprites/battle/furnursus-sheet.png`
- `upstream/mods/tuxemon/gfx/sprites/battle/statursus-sheet.png`
- `upstream/mods/tuxemon/gfx/sprites/battle/coaldiak-sheet.png`
...
- [ ] `MonsterDef` entry for **furnursus** in `src/game/data/monsters.ts`
- [ ] `MonsterDef` entry for **statursus** in `src/game/data/monsters.ts`
- [ ] `MonsterDef` entry for **coaldiak** in `src/game/data/monsters.ts`
- [ ] Battle sprite present at `public/assets/sprites/battle/furnursus-sheet.png`
- [ ] Battle sprite present at `public/assets/sprites/battle/statursus-sheet.png`
- [ ] Battle sprite present at `public/assets/sprites/battle/coaldiak-sheet.png`
