# STORY-0140: Merlicun monster line

## Description

Port the merlicun-line evolution line from upstream Tuxemon into Arithmon. This is a content-only story — the monster engine (types, stats, moves, evolution, combat) is in place; this story registers the species in our data layer and copies the sprite assets.

The chain contains 2 monsters:
- **merlicun** (basic, varmint, cosmic/normal) — evolves into firomenis at see upstream YAML
- **firomenis** (stage1, dragon, metal/cosmic) — evolves from merlicun

### Upstream reference

- `upstream/mods/tuxemon/db/monster/merlicun.yaml`
- `upstream/mods/tuxemon/db/monster/firomenis.yaml`
- Sprites:
- `upstream/mods/tuxemon/gfx/sprites/battle/merlicun-sheet.png`
- `upstream/mods/tuxemon/gfx/sprites/battle/firomenis-sheet.png`
...
- [ ] `MonsterDef` entry for **merlicun** in `src/game/data/monsters.ts`
- [ ] `MonsterDef` entry for **firomenis** in `src/game/data/monsters.ts`
- [ ] Battle sprite present at `public/assets/sprites/battle/merlicun-sheet.png`
- [ ] Battle sprite present at `public/assets/sprites/battle/firomenis-sheet.png`
