# STORY-0132: Fancair monster line

## Description

Port the fancair-line evolution line from upstream Tuxemon into Arithmon. This is a content-only story — the monster engine (types, stats, moves, evolution, combat) is in place; this story registers the species in our data layer and copies the sprite assets.

The chain contains 2 monsters:
- **fancair** (basic, sprite, lightning/sky) — evolves into windeye at see upstream YAML
- **windeye** (stage1, humanoid, lightning/metal) — evolves from fancair

### Upstream reference

- `upstream/mods/tuxemon/db/monster/fancair.yaml`
- `upstream/mods/tuxemon/db/monster/windeye.yaml`
- Sprites:
- `upstream/mods/tuxemon/gfx/sprites/battle/fancair-sheet.png`
- `upstream/mods/tuxemon/gfx/sprites/battle/windeye-sheet.png`
...
- [ ] `MonsterDef` entry for **fancair** in `src/game/data/monsters.ts`
- [ ] `MonsterDef` entry for **windeye** in `src/game/data/monsters.ts`
- [ ] Battle sprite present at `public/assets/sprites/battle/fancair-sheet.png`
- [ ] Battle sprite present at `public/assets/sprites/battle/windeye-sheet.png`
