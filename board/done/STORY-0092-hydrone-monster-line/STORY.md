# STORY-0092: Hydrone monster line

## Description

Port the hydrone-line evolution line from upstream Tuxemon into Arithmon. This is a content-only story — the monster engine (types, stats, moves, evolution, combat) is in place; this story registers the species in our data layer and copies the sprite assets.

The chain contains 1 monster:
- **hydrone** (standalone — does not evolve, humanoid, metal/water) — terminal (no evolution)

### Upstream reference

- `upstream/mods/tuxemon/db/monster/hydrone.yaml`
- Sprites:
- `upstream/mods/tuxemon/gfx/sprites/battle/hydrone-sheet.png`
...
- [ ] `MonsterDef` entry for **hydrone** in `src/game/data/monsters.ts`
- [ ] Battle sprite present at `public/assets/sprites/battle/hydrone-sheet.png`
