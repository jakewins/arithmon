# STORY-0171: Flacono monster line

## Description

Port the flacono-line evolution line from upstream Tuxemon into Arithmon. This is a content-only story — the monster engine (types, stats, moves, evolution, combat) is in place; this story registers the species in our data layer and copies the sprite assets.

The chain contains 3 monsters:
- **flacono** (basic, flier, sky) — evolves into corvix at see upstream YAML
- **corvix** (stage1, flier, sky) — evolves into gryfix at level 18
- **gryfix** (stage2, flier, sky) — evolves from corvix

### Upstream reference

- `upstream/mods/tuxemon/db/monster/flacono.yaml`
- `upstream/mods/tuxemon/db/monster/corvix.yaml`
- `upstream/mods/tuxemon/db/monster/gryfix.yaml`
- Sprites:
- `upstream/mods/tuxemon/gfx/sprites/battle/flacono-sheet.png`
- `upstream/mods/tuxemon/gfx/sprites/battle/corvix-sheet.png`
- `upstream/mods/tuxemon/gfx/sprites/battle/gryfix-sheet.png`
...
- [ ] `MonsterDef` entry for **flacono** in `src/game/data/monsters.ts`
- [ ] `MonsterDef` entry for **corvix** in `src/game/data/monsters.ts`
- [ ] `MonsterDef` entry for **gryfix** in `src/game/data/monsters.ts`
- [ ] Battle sprite present at `public/assets/sprites/battle/flacono-sheet.png`
- [ ] Battle sprite present at `public/assets/sprites/battle/corvix-sheet.png`
- [ ] Battle sprite present at `public/assets/sprites/battle/gryfix-sheet.png`
