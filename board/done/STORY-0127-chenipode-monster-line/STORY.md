# STORY-0127: Chenipode monster line

## Description

Port the chenipode-line evolution line from upstream Tuxemon into Arithmon. This is a content-only story — the monster engine (types, stats, moves, evolution, combat) is in place; this story registers the species in our data layer and copies the sprite assets.

The chain contains 2 monsters:
- **chenipode** (basic, grub, normal) — evolves into exapode at see upstream YAML
- **exapode** (stage1, grub, normal) — evolves from chenipode

### Upstream reference

- `upstream/mods/tuxemon/db/monster/chenipode.yaml`
- `upstream/mods/tuxemon/db/monster/exapode.yaml`
- Sprites:
- `upstream/mods/tuxemon/gfx/sprites/battle/chenipode-sheet.png`
- `upstream/mods/tuxemon/gfx/sprites/battle/exapode-sheet.png`
...
- [ ] `MonsterDef` entry for **chenipode** in `src/game/data/monsters.ts`
- [ ] `MonsterDef` entry for **exapode** in `src/game/data/monsters.ts`
- [ ] Battle sprite present at `public/assets/sprites/battle/chenipode-sheet.png`
- [ ] Battle sprite present at `public/assets/sprites/battle/exapode-sheet.png`
