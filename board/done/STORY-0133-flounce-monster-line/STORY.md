# STORY-0133: Flounce monster line

## Description

Port the flounce-line evolution line from upstream Tuxemon into Arithmon. This is a content-only story — the monster engine (types, stats, moves, evolution, combat) is in place; this story registers the species in our data layer and copies the sprite assets.

The chain contains 2 monsters:
- **flounce** (basic, hunter, fire) — evolves into knindling at see upstream YAML
- **knindling** (stage1, hunter, fire) — evolves from flounce

### Upstream reference

- `upstream/mods/tuxemon/db/monster/flounce.yaml`
- `upstream/mods/tuxemon/db/monster/knindling.yaml`
- Sprites:
- `upstream/mods/tuxemon/gfx/sprites/battle/flounce-sheet.png`
- `upstream/mods/tuxemon/gfx/sprites/battle/knindling-sheet.png`
...
- [ ] `MonsterDef` entry for **flounce** in `src/game/data/monsters.ts`
- [ ] `MonsterDef` entry for **knindling** in `src/game/data/monsters.ts`
- [ ] Battle sprite present at `public/assets/sprites/battle/flounce-sheet.png`
- [ ] Battle sprite present at `public/assets/sprites/battle/knindling-sheet.png`
