# STORY-0126: Capiti monster line

## Description

Port the capiti-line evolution line from upstream Tuxemon into Arithmon. This is a content-only story — the monster engine (types, stats, moves, evolution, combat) is in place; this story registers the species in our data layer and copies the sprite assets.

The chain contains 2 monsters:
- **capiti** (basic, sprite, normal) — evolves into capinyah at see upstream YAML
- **capinyah** (stage1, humanoid, heroic) — evolves from capiti

### Upstream reference

- `upstream/mods/tuxemon/db/monster/capiti.yaml`
- `upstream/mods/tuxemon/db/monster/capinyah.yaml`
- Sprites:
- `upstream/mods/tuxemon/gfx/sprites/battle/capiti-sheet.png`
- `upstream/mods/tuxemon/gfx/sprites/battle/capinyah-sheet.png`
...
- [ ] `MonsterDef` entry for **capiti** in `src/game/data/monsters.ts`
- [ ] `MonsterDef` entry for **capinyah** in `src/game/data/monsters.ts`
- [ ] Battle sprite present at `public/assets/sprites/battle/capiti-sheet.png`
- [ ] Battle sprite present at `public/assets/sprites/battle/capinyah-sheet.png`
