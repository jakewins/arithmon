# STORY-0141: Metesaur monster line

## Description

Port the metesaur-line evolution line from upstream Tuxemon into Arithmon. This is a content-only story — the monster engine (types, stats, moves, evolution, combat) is in place; this story registers the species in our data layer and copies the sprite assets.

The chain contains 2 monsters:
- **metesaur** (basic, flier, earth/fire) — evolves into qetzlrokilus at see upstream YAML
- **qetzlrokilus** (stage1, flier, earth/fire) — evolves from metesaur

### Upstream reference

- `upstream/mods/tuxemon/db/monster/metesaur.yaml`
- `upstream/mods/tuxemon/db/monster/qetzlrokilus.yaml`
- Sprites:
- `upstream/mods/tuxemon/gfx/sprites/battle/metesaur-sheet.png`
- `upstream/mods/tuxemon/gfx/sprites/battle/qetzlrokilus-sheet.png`
...
- [ ] `MonsterDef` entry for **metesaur** in `src/game/data/monsters.ts`
- [ ] `MonsterDef` entry for **qetzlrokilus** in `src/game/data/monsters.ts`
- [ ] Battle sprite present at `public/assets/sprites/battle/metesaur-sheet.png`
- [ ] Battle sprite present at `public/assets/sprites/battle/qetzlrokilus-sheet.png`
