# STORY-0178: Nut monster line

## Description

Port the nut-line evolution line from upstream Tuxemon into Arithmon. This is a content-only story — the monster engine (types, stats, moves, evolution, combat) is in place; this story registers the species in our data layer and copies the sprite assets.

The chain contains 3 monsters:
- **nut** (basic, blob, metal) — evolves into bolt at see upstream YAML
- **bolt** (stage1, blob, metal) — evolves into arthrobolt at level 9
- **arthrobolt** (stage2, humanoid, lightning/metal) — evolves from bolt

### Upstream reference

- `upstream/mods/tuxemon/db/monster/nut.yaml`
- `upstream/mods/tuxemon/db/monster/bolt.yaml`
- `upstream/mods/tuxemon/db/monster/arthrobolt.yaml`
- Sprites:
- `upstream/mods/tuxemon/gfx/sprites/battle/nut-sheet.png`
- `upstream/mods/tuxemon/gfx/sprites/battle/bolt-sheet.png`
- `upstream/mods/tuxemon/gfx/sprites/battle/arthrobolt-sheet.png`
...
- [ ] `MonsterDef` entry for **nut** in `src/game/data/monsters.ts`
- [ ] `MonsterDef` entry for **bolt** in `src/game/data/monsters.ts`
- [ ] `MonsterDef` entry for **arthrobolt** in `src/game/data/monsters.ts`
- [ ] Battle sprite present at `public/assets/sprites/battle/nut-sheet.png`
- [ ] Battle sprite present at `public/assets/sprites/battle/bolt-sheet.png`
- [ ] Battle sprite present at `public/assets/sprites/battle/arthrobolt-sheet.png`
