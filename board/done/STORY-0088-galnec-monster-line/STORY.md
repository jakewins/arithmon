# STORY-0088: Galnec monster line

## Description

Port the galnec-line evolution line from upstream Tuxemon into Arithmon. This is a content-only story — the monster engine (types, stats, moves, evolution, combat) is in place; this story registers the species in our data layer and copies the sprite assets.

The chain contains 1 monster:
- **galnec** (standalone — does not evolve, hunter, earth) — terminal (no evolution)

### Upstream reference

- `upstream/mods/tuxemon/db/monster/galnec.yaml`
- Sprites:
- `upstream/mods/tuxemon/gfx/sprites/battle/galnec-sheet.png`
...
- [ ] `MonsterDef` entry for **galnec** in `src/game/data/monsters.ts`
- [ ] Battle sprite present at `public/assets/sprites/battle/galnec-sheet.png`
