# STORY-0116: Xeon_2 monster line

## Description

Port the xeon_2-line evolution line from upstream Tuxemon into Arithmon. This is a content-only story — the monster engine (types, stats, moves, evolution, combat) is in place; this story registers the species in our data layer and copies the sprite assets.

The chain contains 1 monster:
- **xeon_2** (standalone — does not evolve, humanoid, metal) — terminal (no evolution)

### Upstream reference

- `upstream/mods/tuxemon/db/monster/xeon_2.yaml`
- Sprites:
- `upstream/mods/tuxemon/gfx/sprites/battle/xeon_2-sheet.png`
...
- [ ] `MonsterDef` entry for **xeon_2** in `src/game/data/monsters.ts`
- [ ] Battle sprite present at `public/assets/sprites/battle/xeon_2-sheet.png`
