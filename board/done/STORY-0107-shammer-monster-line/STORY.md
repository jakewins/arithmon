# STORY-0107: Shammer monster line

## Description

Port the shammer-line evolution line from upstream Tuxemon into Arithmon. This is a content-only story — the monster engine (types, stats, moves, evolution, combat) is in place; this story registers the species in our data layer and copies the sprite assets.

The chain contains 1 monster:
- **shammer** (standalone — does not evolve, hunter, earth) — terminal (no evolution)

### Upstream reference

- `upstream/mods/tuxemon/db/monster/shammer.yaml`
- Sprites:
- `upstream/mods/tuxemon/gfx/sprites/battle/shammer-sheet.png`
...
- [ ] `MonsterDef` entry for **shammer** in `src/game/data/monsters.ts`
- [ ] Battle sprite present at `public/assets/sprites/battle/shammer-sheet.png`
