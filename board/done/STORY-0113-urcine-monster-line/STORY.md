# STORY-0113: Urcine monster line

## Description

Port the urcine-line evolution line from upstream Tuxemon into Arithmon. This is a content-only story — the monster engine (types, stats, moves, evolution, combat) is in place; this story registers the species in our data layer and copies the sprite assets.

The chain contains 1 monster:
- **urcine** (standalone — does not evolve, brute, shadow/heroic) — terminal (no evolution)

### Upstream reference

- `upstream/mods/tuxemon/db/monster/urcine.yaml`
- Sprites:
- `upstream/mods/tuxemon/gfx/sprites/battle/urcine-sheet.png`
...
- [ ] `MonsterDef` entry for **urcine** in `src/game/data/monsters.ts`
- [ ] Battle sprite present at `public/assets/sprites/battle/urcine-sheet.png`
