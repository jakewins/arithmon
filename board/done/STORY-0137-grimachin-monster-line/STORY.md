# STORY-0137: Grimachin monster line

## Description

Port the grimachin-line evolution line from upstream Tuxemon into Arithmon. This is a content-only story — the monster engine (types, stats, moves, evolution, combat) is in place; this story registers the species in our data layer and copies the sprite assets.

The chain contains 2 monsters:
- **grimachin** (basic, hunter, metal) — evolves into tigrock at see upstream YAML
- **tigrock** (stage1, hunter, metal) — evolves from grimachin

### Upstream reference

- `upstream/mods/tuxemon/db/monster/grimachin.yaml`
- `upstream/mods/tuxemon/db/monster/tigrock.yaml`
- Sprites:
- `upstream/mods/tuxemon/gfx/sprites/battle/grimachin-sheet.png`
- `upstream/mods/tuxemon/gfx/sprites/battle/tigrock-sheet.png`
...
- [ ] `MonsterDef` entry for **grimachin** in `src/game/data/monsters.ts`
- [ ] `MonsterDef` entry for **tigrock** in `src/game/data/monsters.ts`
- [ ] Battle sprite present at `public/assets/sprites/battle/grimachin-sheet.png`
- [ ] Battle sprite present at `public/assets/sprites/battle/tigrock-sheet.png`
