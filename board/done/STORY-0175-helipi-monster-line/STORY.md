# STORY-0175: Helipi monster line

## Description

Port the helipi-line evolution line from upstream Tuxemon into Arithmon. This is a content-only story — the monster engine (types, stats, moves, evolution, combat) is in place; this story registers the species in our data layer and copies the sprite assets.

The chain contains 3 monsters:
- **helipi** (basic, blob, wood/sky) — evolves into coppi at see upstream YAML
- **coppi** (stage1, blob, wood/sky) — evolves into parappi at level 15
- **parappi** (stage2, blob, wood/sky) — evolves from coppi

### Upstream reference

- `upstream/mods/tuxemon/db/monster/helipi.yaml`
- `upstream/mods/tuxemon/db/monster/coppi.yaml`
- `upstream/mods/tuxemon/db/monster/parappi.yaml`
- Sprites:
- `upstream/mods/tuxemon/gfx/sprites/battle/helipi-sheet.png`
- `upstream/mods/tuxemon/gfx/sprites/battle/coppi-sheet.png`
- `upstream/mods/tuxemon/gfx/sprites/battle/parappi-sheet.png`
...
- [ ] `MonsterDef` entry for **helipi** in `src/game/data/monsters.ts`
- [ ] `MonsterDef` entry for **coppi** in `src/game/data/monsters.ts`
- [ ] `MonsterDef` entry for **parappi** in `src/game/data/monsters.ts`
- [ ] Battle sprite present at `public/assets/sprites/battle/helipi-sheet.png`
- [ ] Battle sprite present at `public/assets/sprites/battle/coppi-sheet.png`
- [ ] Battle sprite present at `public/assets/sprites/battle/parappi-sheet.png`
