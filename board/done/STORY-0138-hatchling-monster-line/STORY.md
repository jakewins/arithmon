# STORY-0138: Hatchling monster line

## Description

Port the hatchling-line evolution line from upstream Tuxemon into Arithmon. This is a content-only story — the monster engine (types, stats, moves, evolution, combat) is in place; this story registers the species in our data layer and copies the sprite assets.

The chain contains 2 monsters:
- **hatchling** (basic, flier, sky) — evolves into birdling at see upstream YAML
- **birdling** (stage1, flier, sky) — evolves from hatchling

### Upstream reference

- `upstream/mods/tuxemon/db/monster/hatchling.yaml`
- `upstream/mods/tuxemon/db/monster/birdling.yaml`
- Sprites:
- `upstream/mods/tuxemon/gfx/sprites/battle/hatchling-sheet.png`
- `upstream/mods/tuxemon/gfx/sprites/battle/birdling-sheet.png`
...
- [ ] `MonsterDef` entry for **hatchling** in `src/game/data/monsters.ts`
- [ ] `MonsterDef` entry for **birdling** in `src/game/data/monsters.ts`
- [ ] Battle sprite present at `public/assets/sprites/battle/hatchling-sheet.png`
- [ ] Battle sprite present at `public/assets/sprites/battle/birdling-sheet.png`
