# STORY-0117: Xeon monster line

## Description

Port the xeon-line evolution line from upstream Tuxemon into Arithmon. This is a content-only story — the monster engine (types, stats, moves, evolution, combat) is in place; this story registers the species in our data layer and copies the sprite assets.

The chain contains 1 monster:
- **xeon** (standalone — does not evolve, humanoid, metal) — terminal (no evolution)

### Upstream reference

- `upstream/mods/tuxemon/db/monster/xeon.yaml`
- Sprites:
- `upstream/mods/tuxemon/gfx/sprites/battle/xeon-sheet.png`
...
- [ ] `MonsterDef` entry for **xeon** in `src/game/data/monsters.ts`
- [ ] Battle sprite present at `public/assets/sprites/battle/xeon-sheet.png`
