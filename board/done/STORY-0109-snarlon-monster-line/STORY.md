# STORY-0109: Snarlon monster line

## Description

Port the snarlon-line evolution line from upstream Tuxemon into Arithmon. This is a content-only story — the monster engine (types, stats, moves, evolution, combat) is in place; this story registers the species in our data layer and copies the sprite assets.

The chain contains 1 monster:
- **snarlon** (standalone — does not evolve, hunter, shadow/normal) — terminal (no evolution)

### Upstream reference

- `upstream/mods/tuxemon/db/monster/snarlon.yaml`
- Sprites:
- `upstream/mods/tuxemon/gfx/sprites/battle/snarlon-sheet.png`
...
- [ ] `MonsterDef` entry for **snarlon** in `src/game/data/monsters.ts`
- [ ] Battle sprite present at `public/assets/sprites/battle/snarlon-sheet.png`
