# STORY-0112: Taupypus monster line

## Description

Port the taupypus-line evolution line from upstream Tuxemon into Arithmon. This is a content-only story — the monster engine (types, stats, moves, evolution, combat) is in place; this story registers the species in our data layer and copies the sprite assets.

The chain contains 1 monster:
- **taupypus** (standalone — does not evolve, varmint, water/normal) — terminal (no evolution)

### Upstream reference

- `upstream/mods/tuxemon/db/monster/taupypus.yaml`
- Sprites:
- `upstream/mods/tuxemon/gfx/sprites/battle/taupypus-sheet.png`
...
- [ ] `MonsterDef` entry for **taupypus** in `src/game/data/monsters.ts`
- [ ] Battle sprite present at `public/assets/sprites/battle/taupypus-sheet.png`
