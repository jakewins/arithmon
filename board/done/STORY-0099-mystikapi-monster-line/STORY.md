# STORY-0099: Mystikapi monster line

## Description

Port the mystikapi-line evolution line from upstream Tuxemon into Arithmon. This is a content-only story — the monster engine (types, stats, moves, evolution, combat) is in place; this story registers the species in our data layer and copies the sprite assets.

The chain contains 1 monster:
- **mystikapi** (standalone — does not evolve, landrace, cosmic) — terminal (no evolution)

### Upstream reference

- `upstream/mods/tuxemon/db/monster/mystikapi.yaml`
- Sprites:
- `upstream/mods/tuxemon/gfx/sprites/battle/mystikapi-sheet.png`
...
- [ ] `MonsterDef` entry for **mystikapi** in `src/game/data/monsters.ts`
- [ ] Battle sprite present at `public/assets/sprites/battle/mystikapi-sheet.png`
