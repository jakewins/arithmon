# STORY-0147: Pantherafira monster line

## Description

Port the pantherafira-line evolution line from upstream Tuxemon into Arithmon. This is a content-only story — the monster engine (types, stats, moves, evolution, combat) is in place; this story registers the species in our data layer and copies the sprite assets.

The chain contains 2 monsters:
- **pantherafira** (basic, hunter, fire/normal) — evolves into criniotherme at see upstream YAML
- **criniotherme** (stage1, hunter, fire/normal) — evolves from pantherafira

### Upstream reference

- `upstream/mods/tuxemon/db/monster/pantherafira.yaml`
- `upstream/mods/tuxemon/db/monster/criniotherme.yaml`
- Sprites:
- `upstream/mods/tuxemon/gfx/sprites/battle/pantherafira-sheet.png`
- `upstream/mods/tuxemon/gfx/sprites/battle/criniotherme-sheet.png`
...
- [ ] `MonsterDef` entry for **pantherafira** in `src/game/data/monsters.ts`
- [ ] `MonsterDef` entry for **criniotherme** in `src/game/data/monsters.ts`
- [ ] Battle sprite present at `public/assets/sprites/battle/pantherafira-sheet.png`
- [ ] Battle sprite present at `public/assets/sprites/battle/criniotherme-sheet.png`
