# STORY-0119: Zunna monster line

## Description

Port the zunna-line evolution line from upstream Tuxemon into Arithmon. This is a content-only story — the monster engine (types, stats, moves, evolution, combat) is in place; this story registers the species in our data layer and copies the sprite assets.

The chain contains 1 monster:
- **zunna** (standalone — does not evolve, blob, normal) — terminal (no evolution)

### Upstream reference

- `upstream/mods/tuxemon/db/monster/zunna.yaml`
- Sprites:
- `upstream/mods/tuxemon/gfx/sprites/battle/zunna-sheet.png`
...
- [ ] `MonsterDef` entry for **zunna** in `src/game/data/monsters.ts`
- [ ] Battle sprite present at `public/assets/sprites/battle/zunna-sheet.png`
