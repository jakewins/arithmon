# STORY-0142: Noctula monster line

## Description

Port the noctula-line evolution line from upstream Tuxemon into Arithmon. This is a content-only story — the monster engine (types, stats, moves, evolution, combat) is in place; this story registers the species in our data layer and copies the sprite assets.

The chain contains 2 monsters:
- **noctula** (basic, flier, sky/shadow) — evolves into noctalo at see upstream YAML
- **noctalo** (stage1, flier, sky/shadow) — evolves from noctula

### Upstream reference

- `upstream/mods/tuxemon/db/monster/noctula.yaml`
- `upstream/mods/tuxemon/db/monster/noctalo.yaml`
- Sprites:
- `upstream/mods/tuxemon/gfx/sprites/battle/noctula-sheet.png`
- `upstream/mods/tuxemon/gfx/sprites/battle/noctalo-sheet.png`
...
- [ ] `MonsterDef` entry for **noctula** in `src/game/data/monsters.ts`
- [ ] `MonsterDef` entry for **noctalo** in `src/game/data/monsters.ts`
- [ ] Battle sprite present at `public/assets/sprites/battle/noctula-sheet.png`
- [ ] Battle sprite present at `public/assets/sprites/battle/noctalo-sheet.png`
